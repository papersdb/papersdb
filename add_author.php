...
<body>
<form name="authorForm" action="./add_publication.php?<? echo $_SERVER['QUERY_STRING'] ?>" method="POST" enctype="application/x-www-form-urlencoded" target="add_publication.php" onsubmit="setTimeout('self.close()',0);">
	<table width="590" border="0" cellspacing="0" cellpadding="6">
	  ...
	  <tr>
		<td>
			<a href="./help.php" target="_blank" onClick="window.open('./help.php?helpcat=AddAuthor', 'Help', 'width=400,height=400'); return false"><img src="./question_mark_sm.JPG" border="0" alt="help"></a>
		</td>
		<td colspan="2" width="75%" align="left">
			<input type="SUBMIT" name="Submit" value="Add Author" class="text" onClick="return verify();">&nbsp;&nbsp;<input type="RESET" name="Reset" value="Reset" class="text" onClick="resetAll();">
