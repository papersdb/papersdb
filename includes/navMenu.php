...
$page_info = array(
    'add_publication'
    => array('Add Publication', 'Admin/add_publication.php', 1),
    'add_author'
    => array('Add Author', 'Admin/add_author.php', 1),
    'advanced_search'
    => array('Advanced Search', 'advanced_search.php', 0),
    'all_publications'
    => array('All Publications', 'list_publication.php', 0),
    'all_authors'
    => array('All Authors', 'list_authors.php', 0),
    'logout'
    => array('Logout', 'logout.php', 1),
    'login'
