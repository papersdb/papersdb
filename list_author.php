...
/* This portion is used for when a new author has been added. It either says it
 * was successful or not and then brings the user to this full page.
*/
if ($admin == "true"){
	if ($newauthor == "true") {
    ...
    print "<h3><a href='Admin/add_author.php?popup=false'>"
        . "<b>Add New Author</b></a></h3>";
}
