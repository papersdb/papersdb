...
<?
/* add_category.php
	This is the form portion of adding/editing a category. 
	The changes in the database actually are made in add_publication.php. 
	This is so when the category is added to the database the publication 
	a user is working in is then updated with that category available to them. 
*/
