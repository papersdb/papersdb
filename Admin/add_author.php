<html>
<head>
<title>Add Author</title></title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<?
/* add_author.php
	This is the form portion of adding/editing an author. 
	The changes in the database actually are made in add_publication.php. 
	This is so when the author is added to the database the publication 
	a user is working in is then updated with that author available to them. 
	...
	add_publication page with the fields restored and author added to the list. 
		...
		If the user chooses "add new publication" from the list_authors.php page. 
	Then the information will be sent to add_publication and the author will be
	added to the database, the user will be given confirmation and the option
	to return to the authors page or go the admin menu(index.php).
*/
