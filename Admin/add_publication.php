...
/* add_publication.php
	...
	This page is the form for adding/editing a publication. It
	has many side functions that are  needed for the form to work
	smoothly. It takes the input from the user, and then sends
	that input to add_publication_db.php.
...
function popularauthors(){
		$userauthorcount = 0;
		$user_query = "SELECT pub_author.author_id FROM pub_author, publication, user
						WHERE
							publication.submit = user.name AND
...
if(($intpoint == "")&&($ext == "")){
	$point_query = "SELECT type, name, value FROM pointer WHERE pub_id=".$_GET['pub_id'];
...
// Jeff: this looks like a no-op to me
//$newAuthorSubmitted == "false";
...
<font face="Arial, Helvetica, sans-serif" size="1" color="red">For help on any field just click the field name.</font>
...
<tr><td colspan="2"><hr></td><tr><td colspan="2"><font size="4"><b>Step 1:</b></font><br></td></tr>
<!-- Publication Venue -->
<?
		if ($edit == true) {
...
?>
<tr>
		<td width="25%" valign="top"><A href="javascript:help('publication_venue');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>Publication Venue: </b></font></A></td>
		<td width="75%">
...
<!-- Category -->
	  <tr>
		<td width="25%" valign="top"><A href="javascript:help('category');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>Category: </b></font></a></td>
		<td width="75%">
...
// User selected author list
		...
		$user_query = "SELECT author.author_id, author.name FROM user_author, author WHERE user_author.author_id=author.author_id AND user_author.login=\"".$_SERVER['PHP_AUTH_USER']."\" ORDER BY author.name";
		$user_result = mysql_query($user_query) or die("Query failed: " . mysql_error());

		while($user_array = mysql_fetch_array($user_result, MYSQL_ASSOC))
			{
				echo "<li><a href=\"javascript:opt.moveToLeft(".$user_array['author_id'].");\"><font face=\"Arial, Helvetica, sans-serif\" size=\"2\">".$user_array['name']."</font></a><br>";
			}

		?>
			&nbsp;&nbsp;<font align=bottom face="Arial, Helvetica, sans-serif\" size="1"><a href ="login.php?status=edit">Add/Change collaborators</a></font>
			</td></tr></table></td>
...
echo "<tr>";
if($venue_type != "") { ?>
<td width="25%" valign="top"><font face="Arial, Helvetica, sans-serif" size="2"><b><? echo $venue_type; ?>: </b></font></td>
<? }	echo "<td>";
if($venue_url != "")
...
if($venue_data != ""){
	echo "<tr>";
	?>
	<td width="25%" valign="top"><font face="Arial, Helvetica, sans-serif" size="2"><b>
	<?
	if($venue_type == "Conference")
		echo "Location:";
	else if($venue_type == "Journal")
		...
		<?
	echo $venue_data."</td></tr>";
}

} ?>
<? if($venue_id == -2) { ?>
	<tr>
		<td width="25%" valign="top"><font face="Arial, Helvetica, sans-serif" size="2"><b>Unique Venue:</b></font><BR>
		<font face="Arial, Helvetica, sans-serif" size="1" color="red">HTML enabled</font></td>
		<td width="75%"><textarea name="venue" cols="70" rows="5"><? echo stripslashes($venue); ?></textarea></td>
	  </tr>
<? } ?>
<!-- Extra Information -->
<? if($extrainfoSubmitted){
	  ...
	  <tr>
		<td width="25%" valign="top"><A href="javascript:help('extra_information');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>Extra Information:</b></a><A NAME=extra></a></font><BR> <font size="1">Optional</font></td>
		<td width="75%"><textarea name="extra_info" cols="70" rows="5"><? echo stripslashes($extra_info); ?></textarea>
	 	<BR>&nbsp;&nbsp;<a href="javascript:dataKeepPopup('extra_info.php');"><font face="Arial, Helvetica, sans-serif" size="1">Select from a list of previously used information options</font></a>
	 	</td>
	  </tr>
<!-- Pointers -->
      <? if($ext == "")
	  ...
	  $e = 0; do{ ?>
	  <tr>
		<td width="25%" valign="top"><? if($e == 0) { ?><A NAME=pointers></a><A href="javascript:help('pointers');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>External Pointers:</b></font></A><BR> <font size="1">Optional</font><? } ?></td>
		<td width="75%">
		<? if($ext != 0) {
		      $tempname = "extname".$e;
			  ...
			  ?>
			<table><tr>
				<td><input type="text" name="extname<? echo $e ?>" size="17" maxlength="250" value="<? echo $$tempname ?>"><b> :</b></td>
				<td><input type="text" name="extvalue<? echo $e ?>" size="20" maxlength="250" value="<? echo $$tempvalue ?>"></td>
				<td><input type="text" name="extlink<? echo $e ?>" size="30" maxlength="250" value="<? echo $$templink ?>"></td>
	    	</tr></table>
			<? }
	     else { ?>
		 <a href="javascript:dataKeep('addext');"><font face="Arial, Helvetica, sans-serif" size="3">Add an external pointer</a>
		<? } ?>
		</td>
	  </tr>
	...
	<? if($e == ($ext-1)) { ?>
		 <tr><td></td><td valign="top">&nbsp;&nbsp;
			<a href="javascript:dataKeep('addext');"><font face="Arial, Helvetica, sans-serif" size="1">Add another external pointer</a>
		<? if ($ext > 0) { ?>
			&nbsp;&nbsp;<a href="javascript:dataKeep('remext');">Remove the above pointer</a>
		<? } ?> </font></td></tr>
	<? } $e++; }while($e < $ext); ?>
	<? $e = 0; do{ ?>
	  <tr>
		<td width="25%" valign="top"><? if($e == 0) { ?><A href="javascript:help('pointers');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>Internal Pointers:</b></font></A><BR> <font size="1">Optional</font><? } ?></td>
		<td width="75%">
		  <? if($intpoint != 0) { ?>
			<select name="intpointer<? echo $e ?>">
				...
				<? 	$pubs_query = "SELECT title, pub_id FROM publication";
					...
					while ($pubs_line = mysql_fetch_array($pubs_result, MYSQL_ASSOC)) {
						...
						if(strlen($tempstring) > 70) {$tempstring = substr($tempstring,0,67)."...";}
		...
		<? }
		   ...
		   <a href="javascript:dataKeep('addint');"><font face="Arial, Helvetica, sans-serif" size="3">Add an internal pointer</font></a>
		   <? } ?>
		</td>
	  </tr>
	...
	<? if($e == ($intpoint-1)) { ?>
		 <tr><td></td><td valign="top">&nbsp;&nbsp;
			<a href="javascript:dataKeep('addint');"><font face="Arial, Helvetica, sans-serif" size="1">Add another internal pointer</a>
		<? if ($intpoint > 0) { ?>
			&nbsp;&nbsp;<a href="javascript:dataKeep('remint');">Remove the above pointer</a>
		<? } ?> </font></td></tr>
	<? } $e++; }while($e < $intpoint); ?>
...
<!-- STEP 2 -->
	  ...
	  <tr>
		<td colpsan="2"><A NAME=STEP2><font size="4"><b>Step 2:</b></font></A></td>

	  </tr>

<!-- The Paper -->
	  <tr>
		<td width="25%" valign="top"><A href="javascript:help('paper');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>Paper: </b></a></font></td>
<?  if ($edit) { ?>
  <td width="75%"> <? echo $paper; ?> &nbsp; &nbsp; &nbsp;
     <a href="javascript:dataKeepPopupWithID('change_paper.php', <? echo $pub_id; ?>);"><font face="Arial, Helvetica, sans-serif" size="1">Change Paper</font></a>
  </td>
<?
  }
  else {
  ?>
  <td width="75%">
     <input type="radio" name="nopaper" value="false"<? if(($nopaper == "false")||($nopaper == ""))echo "checked"; ?>><input type="file" name="uploadpaper" size="60" maxlength="250"><br>
     <input type="radio" name="nopaper" value="true"<? if($nopaper == "true")echo "checked"; ?>> No paper at this time.
  </td>
<? } ?>
	  </tr>
<!-- Additional Materials -->
<? if($numMaterials > 0) { ?>
<tr><td width="25%" valign="top"><A href="javascript:help('additional_materials');"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><b>Additional Materials: </b></a></font></td>
	  </tr>
<? } ?>
...
?>		<td width="25%"><font face="Arial, Helvetica, sans-serif" size="2" color="#990000"><b><?  if($add_info_array[1] != "") echo $add_info_array[1]; else echo "Additional Material ".($i+1); ?>: </b></font></td>
		<td width="75%">  <? echo $add_info_array[0]; ?> &nbsp; &nbsp; &nbsp; <a href="javascript:" onClick="javascript:window.open('<? echo "delete.php?info=$pub_id/$i&confirm=false" ?>','deleteadd','width=200,height=200,directories=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,resizable=no')"><font face="Arial, Helvetica, sans-serif" size="1">Delete</font></a> </td>
<?
	       }
	       else {
?>		<td width="25%"><input type="text" name="type<? echo $i ?>" size="17" maxlength="250" value="Additional Material <? echo $i+1; ?>"><b> :</b></td>
		<td width="75%"><input type="file" name="uploadadditional<? echo $i ?>" size="50" maxlength="250"></td>
...
<? }
	...
	<tr><td></td>
	<td><? if($numMaterials == "") { $numMaterials = 0; }?>
		<input type="hidden" name="numMaterials" value="<? echo $numMaterials;?>">
	&nbsp;&nbsp;<a href="javascript:dataKeep('addnum');"><font face="Arial, Helvetica, sans-serif" size="1">Add other material</a>
	<? if ($numMaterials > 0) { ?>
		&nbsp;&nbsp;<a href="javascript:dataKeep('remnum');">Remove this material</a>
	<? } ?> </font>
	</td>
	</tr>
	  <tr>
